import styles from "./PolticasDevolucin.module.css";

const PolticasDevolucin = () => {
  return (
    <div className={styles.polticasDevolucin}>
      ...
      <div className={styles.header}>
        <div className={styles.title}>
          <b className={styles.polticasDeDevolucin}>Políticas de devolución</b>
        </div>
      </div>
    </div>
  );
...
export default PolticasDevolucin;
